...
ans = {"blockage" : [{"latitude": lat1, "longitude": long1, "class": "blockage"}] }
...
for i in range(8):
    ...
    if(slope<=0):
        jsonString["blockage"].append({"latitude": lat2, "longitude": long2, "class": "blockage"})

j = json.dumps(jsonString, indent=4)
